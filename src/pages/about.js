...
const about = () => {
    return (
        <>
            <Head>
                <title>Sahil Gupta | About Page</title>
            ...
            <main className='w-full flex flex-col items-center justify-center'>
                <Layout className='pt-16'>
                    <AnimatedText
                        text={'Fueling Purpose with Unbridled Passion!.'}
                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        ...
                        <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 max-w-full overflow-hidden bg-cover bg-no-repeat dark:bg-dark dark:border-light dark:border-t-[1px] dark:border-l-[1px] dark:border-b-[10px] dark:border-r-[10px] xl:col-span-4 md:order-1 md:col-span-8'>
                            <Image
                                src={profilePic}
                                alt='Developer'
